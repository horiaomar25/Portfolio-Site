    ...
    <>
      <section className="flex justify-center items-center px-30 p-6 m-4 sm:flex sm:flex-col sm:w-auto md:flex md:flex-col">
        <div className="overflow-hidden w-full md:w-1/2 text-center sm:flex sm:flex-col">
          ...
          <div className="flex flex-wrap mt-4 items-center justify-center md:flex md:flex-col">
            <a
              ...
              rel="noreferrer"
            >
              <button className="w-52 rounded-xl font-bold text m-0 p-0">Github</button>
            </a>
            <a
              ...
              rel="noreferrer"
            >
              <button className="w-52 rounded-xl font-bold m-0 p-0">Linkedin</button>
            </a>
          </div>
        </div>
